      ...
      <div className="p-8 space-y-6">
        ...
        <Card className="bg-card border-border">
          <CardContent className="pt-6">
            <div className="text-center space-y-4">
              ...
              <Progress value={(correctCount / questions.length) * 100} className="mt-4" />
            </div>
          </CardContent>
        </Card>
        ...
        <div className="space-y-3">
          {questions.map((q, idx) => {
            ...
            return (
              <Card key={q.id} className={`bg-card border-border ${isCorrect ? "border-green-500" : "border-red-500"}`}>
                <CardContent className="pt-6">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-muted-foreground mt-1">Your answer: {answers[q.id]}</p>
